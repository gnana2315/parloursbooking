        ...
        <div class="row fill_height">
            <div class="col fill_height">
                <div class="listing_image">
                    ...
                    <div class="background_image" style="background-image:url(images/homevisit.webp)"></div>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col">
                    <div class="home_content">
                        <div class="listing_title"><h1>Menik Hair Care</h1></div>
            ...
            <div class="col-lg-8">
                <div class="listing_content">
                    ...
                    <form class="listing_service_form" id="listing_service_form">
                        <label class="container listing_service_container">
                            <h3>Gray Coverage</h3>
                            <span>LKR 1,500</span>
                            <input type="checkbox" class="listing_services" name="listedservices" data-name="Gray Coverage" value="1500">
                        </label>
                        <label class="container listing_service_container">
                            <h3>Wash & Cut</h3>
                            <span>LKR 2,500</span>
                            <input type="checkbox" class="listing_services" name="listedservices" data-name="Wash & Cut" value="2500">
                        </label>
                        <label class="container listing_service_container">
                            <h3>Eyebrows Threading</h3>
                            <span>LKR 200</span>
                            <input type="checkbox" class="listing_services" name="listedservices" data-name="Eyebrows Threading" value="200">
                        </label>
                        <label class="container listing_service_container">
                            <h3>Waxing</h3>
                            <span>LKR 1,000</span>
                            <input type="checkbox" class="listing_services" name="listedservices" data-name="Waxing" value="1000">
                        </label>
                ...
                <div class="listing_content">
                    ...
                    <div class="listing_text">
                        <p>Welcome to Menik Hair Care! We're a full service Salon & Bridal Dressing located in Kahanthota, Kaduwela - Malabe Road. We are specialize in Blowdry, Haircuts, Color, Makeup, and Bridals. Give us a call or book online today!</p>
                    </div>
