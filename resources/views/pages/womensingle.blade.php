            ...
            <div class="row">
                <div class="col">
                    <div class="home_content">
                        <div class="listing_title"><h1>Salon Dmesh</h1></div>
                        <div class="listing_info_container d-flex flex-lg-row flex-column align-items-start justify-content-start">
                            <div class="listing_info d-flex flex-row align-items-center justify-content-start">
                                ...
                                <div class="listing_type">Womens Beauty Salon</div>
            ...
            <div class="col-lg-8">
                <div class="listing_content">
                    ...
                    <form class="listing_service_form" id="listing_service_form">
                        <label class="container listing_service_container">
                            <h3>Layer Cuts</h3>
                            <span>LKR 4,500</span>
                            <input type="checkbox" class="listing_services" name="listedservices" data-name="Layer Cuts" value="4500">
                        </label>
                        <label class="container listing_service_container">
                            <h3>Hair Extension Maintenance (Remove, Repair & Fixing)</h3>
                            <span>LKR 18,000</span>
                            <input type="checkbox" class="listing_services" name="listedservices" data-name="Hair Extension Maintenance (Remove, Repair & Fixing)" value="18000">
                        </label>
                        <label class="container listing_service_container">
                            <h3>Ladies Hair Trim</h3>
                            <span>LKR 2,500</span>
                            <input type="checkbox" class="listing_services" name="listedservices" data-name="Ladies Hair Trim" value="2500">
                        </label>
                        <label class="container listing_service_container">
                            <h3>New Hair Extensions (Brazilian Knot)</h3>
                            <span>LKR 55,000</span>
                            <input type="checkbox" class="listing_services" name="listedservices" data-name="New Hair Extensions (Brazilian Knot)" value="55000">
                        </label>
                ...
                <div class="listing_content">
                    ...
                    <div class="listing_text">
                        <p>Welcome to Salon Dmesh, where we create hair and beauty experiences which accentuate our clients’ intrinsic beauty and enhance their personal style. Whether you want to gently evolve, subtly maintain, or completely transform, we will listen carefully to you, and use our intuit</p>
                    </div>
                    ...
                    <div class="sidebar_info">
                        <ul>
                            <li class="d-flex flex-row align-items-start justify-content-start">
                                ...
                                <div class="sidebar_info_content"><span>Address: </span>No.89, Old Road, Navinna, Maharagama</div>
                            </li>
                            <!--li class="d-flex flex-row align-items-start justify-content-start">
