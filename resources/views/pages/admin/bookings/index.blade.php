			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item active">Booking Dashboard</li>
					</ol>
				</div><!-- /.col -->
			</div><!-- /.row -->
		</div><!-- /.container-fluid -->
			...
			<div class="row">
						...
						<div class="card-body">
							...
							<div class="direct-chat-messages">
								...
								<div class="direct-chat-msg">
									...
									<!-- /.direct-chat-infos -->
									<img class="direct-chat-img" src="{{ URL::asset('admin/img/user1-128x128.jpg') }}" alt="message user image">
									<!-- /.direct-chat-img -->
								...
								<div class="direct-chat-msg right">
									...
									<!-- /.direct-chat-infos -->
									<img class="direct-chat-img" src="{{ URL::asset('admin/img/user3-128x128.jpg') }}" alt="message user image">
									<!-- /.direct-chat-img -->
							...
							<div class="direct-chat-contacts">
								<ul class="contacts-list">
									<li>
										<a href="#">
											<img class="contacts-list-img" src="{{ URL::asset('admin/img/user1-128x128.jpg') }}" alt="User Avatar">
									...
									<li>
										<a href="#">
											<img class="contacts-list-img" src="{{ URL::asset('admin/img/user7-128x128.jpg') }}" alt="User Avatar">
											<div class="contacts-list-info">
									...
									<li>
										<a href="#">
											<img class="contacts-list-img" src="{{ URL::asset('admin/img/user3-128x128.jpg') }}" alt="User Avatar">
											<div class="contacts-list-info">
									...
									<li>
										<a href="#">
											<img class="contacts-list-img" src="{{ URL::asset('admin/img/user5-128x128.jpg') }}" alt="User Avatar">
											<div class="contacts-list-info">
									...
									<li>
										<a href="#">
											<img class="contacts-list-img" src="{{ URL::asset('admin/img/user6-128x128.jpg') }}" alt="User Avatar">
											<div class="contacts-list-info">
									...
									<li>
										<a href="#">
											<img class="contacts-list-img" src="{{ URL::asset('admin/img/user8-128x128.jpg') }}" alt="User Avatar">
											<div class="contacts-list-info">
				...
				<section class="col-lg-5 connectedSortable">
					...
					<div class="card bg-gradient-info">
						<div class="card-header border-0">
							<h3 class="card-title"><i class="fas fa-th mr-1"></i>Sales Graph</h3>
							<div class="card-tools">
