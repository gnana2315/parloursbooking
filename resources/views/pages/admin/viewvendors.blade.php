            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item"><a href="/vendor">Vendors List</a></li>
                                ...
                                <div class="active tab-pane" id="attachments">
                                    <div class="post clearfix">
                                        ...
                                        <div>
                                            ...
                                            <embed src="{{ asset('/vendors/'.$parlour_certificate_url) }}" width="100%" height="420px" />
                                        </div>
                                    ...
                                    <div class="post clearfix">
                                        ...
                                        <div>
                                            ...
                                            <embed src="{{ asset('/vendors/'.$br_doc_url) }}" width="100%" height="420px" />
                                        </div>
                                        <!--form class="form-horizontal">
                                            <div class="input-group input-group-sm mb-0">
                                                <input class="form-control form-control-sm" placeholder="Response">
                                    ...
                                    <div class="post clearfix">
                                        ...
                                        <div>
                                            <h5>Owners NIC</h5>
                                            <embed src="{{ asset('/vendors/'.$owners_nic_url) }}" width="100%" height="420px" />
                                        </div>
                                        <!--form class="form-horizontal">
                                            <div class="input-group input-group-sm mb-0">
                                                <input class="form-control form-control-sm" placeholder="Response">
