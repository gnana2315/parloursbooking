 ...
 */
    ...
    /**
 * @OA\Post(
 *     path="/api/payment/webxpay/response",
 *     summary="WebXPay payment response handler",
 *     description="Handles WebXPay payment gateway response, validates signature, and updates booking/payment status",
 ...
 *                     property="payment",
 *                     type="string",
 *                     description="Base64 encoded payment response string from WebXPay",
 *                     example="T1JERVJ8UkVGMTIzfDIwMjQtMDEtMDF8V0VCWFBBWXwwMHxTdWNjZXNz"
 *                 ),
 *                 @OA\Property(
 *                     property="signature",
 *                     type="string",
 *                     description="Base64 encoded RSA signature from WebXPay",
 *                     example="Y2lwaGVyX3NpZ25hdHVyZV9iYXNlNjQ="
 *                 ),
 *                 @OA\Property(
 *                     property="custom_fields",
 *                     type="string",
 *                     nullable=true,
 *                     description="Base64 encoded custom fields (ref_no|booking_id|vendor_id|customer_id)",
 *                     example="UkVGMTIzfDEwMHwyMHwzMA=="
 *                 )
 *             )
 *         )
 *     ),
 ...
 *                 property="data",
 *                 type="object",
 *                 @OA\Property(property="booking_id", type="integer", example=100),
 *                 @OA\Property(property="booking_ref_no", type="string", example="REF123"),
 *                 @OA\Property(property="gateway", type="string", example="WEBXPAY"),
 *                 @OA\Property(property="transaction_date", type="string", example="2024-01-01 10:30:00"),
 *                 @OA\Property(property="comment", type="string", example="Approved")
 *             )
 *         )
 *     ),
 *
 ...
 *                 property="data",
 *                 type="object",
 *                 @OA\Property(property="status_code", type="string", example="01"),
 *                 @OA\Property(property="comment", type="string", example="Insufficient funds")
 *             )
 *         )
 *     ),
 *
 ...
 *         @OA\JsonContent(
 *             @OA\Property(property="status", type="boolean", example=false),
 *             @OA\Property(property="message", type="string", example="Payment response processing failed")
 *         )
 *     )
 * )
 */
