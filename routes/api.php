...
Route::middleware(['auth:sanctum', 'validate.token'])->group(function () {
    ...
    Route::post('/deleteVendorDocument', [VendorController::class, 'deleteVendorDocument' ]);
    ...
    Route::get('/calculate-total', [BookingController::class, 'calculateTotal']);
    ...
    Route::post('/booking/mark-completed', [BookingController::class, 'markBookingCompleted']);
